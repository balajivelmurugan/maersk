  ...
  <div class="vendor-form">
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="form-group">
        ...
        />
        <div v-if="emailExists" class="error-message">Email already exists!</div>
      </div>
...
const checkEmailExists = async () => {
  emailExists.value = await VendorService.checkEmailExists(form.email);
};
...
const submitForm = async () => {
  ...
  try {
    await vendorStore.addVendor({ ...form }).then(() => {
      resetForm();
    });
    success.value = true;
    setTimeout(() => {
